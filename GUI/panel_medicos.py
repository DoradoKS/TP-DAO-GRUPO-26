...
from .consulta_medicos import ConsultaMedicosScreen
...
class PanelMedicos(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        buttons_to_create = [
            ("Dar de Alta Médico", self.abrir_alta),
            ("Modificar / Dar de Baja", self.abrir_gestion),
            ("Consultar Médicos", self.abrir_consulta)
        ]
    ...
    def abrir_consulta(self):
        consulta_window = ConsultaMedicosScreen(self)
